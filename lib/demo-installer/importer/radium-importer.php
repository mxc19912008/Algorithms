							...
							<?php if ( $this->flag_as_imported['content'] && $this->flag_as_imported['widgets'] ) { ?>
								<div class="radium-importer-success">
									<?php if ( ! empty( $this->imported_demos ) ) { ?>
										<p><?php esc_html_e( 'You have successfully imported demo data that was not imported last time.', 'buddy' ); ?></p>
									<?php } else { ?>
										<p><?php esc_html_e( 'You have successfully imported the demo data.', 'buddy' ); ?></p>
									<?php } ?>	
								</div>
							<?php } ?>
